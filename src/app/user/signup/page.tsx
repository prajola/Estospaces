      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#FF7700] hover:bg-[#F97316] text-white rounded-lg font-medium transition-colors mb-4"
          >
          ...
          <Button
            ...
            className="flex items-center justify-center gap-3 border-gray-300 text-gray-700 hover:bg-gray-50"
          >
            <svg
              className="w-5 h-5"
              fill="none"
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link
                href="/user/login"
                className="text-[#FF7700] hover:text-[#F97316] font-semibold"
              >
                Sign in
              </Link>
            </p>
